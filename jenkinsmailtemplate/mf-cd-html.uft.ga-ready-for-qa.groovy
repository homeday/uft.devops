...
def build_label = "UFT_${rel_major_num}_${rel_minor_num}_GA"
if ( rel_svcsp_num != "0" )
	build_label = "UFT_${rel_major_num}_${rel_minor_num}_SP${rel_svcsp_num}_GA"
...
%>
    ...
    <h2>UFT ${release_num} GA is ready for QA!</h2>
