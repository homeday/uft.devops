...
<% } %>
  ...
  <TR><TD><b>BuildVersion</b></TD><TD>${build.getEnvironment().BuildMajorVersion}.${build.getEnvironment().BuildMinorVersion}.${build.getEnvironment().BuildNumber}.${build.getEnvironment().BuildPostfix}</TD></TR>
  ...
  <TR><TD><b>Git path</b></TD><TD><A href="https://github.houston.softwaregrp.net/uft/sprinter.git">https://github.houston.softwaregrp.net/uft/sprinter.git</A></TD></TR>
