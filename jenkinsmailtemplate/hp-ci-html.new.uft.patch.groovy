...
%>
   <TR><TD><b>UFT Patch Setup</b></TD><TD><A href="${build.getEnvironment().PRODUCTS_STORAGE_WIN}\\FT\\QTP\\${build.getEnvironment().Configuration}\\${build.getEnvironment().BuildVersion}\\Patches\\UFT\\${build.getEnvironment().PatchID}\\PatchResult\\default\\${build.getEnvironment().PatchID}.exe">Installation Link</A></TD></TR>
<% } 
%>
