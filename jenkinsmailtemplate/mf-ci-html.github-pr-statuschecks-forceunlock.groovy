...
def st_contexts = build.getEnvironment().Github_StatusChecks_Contexts
...
%>
    ...
    <h3>
        Attention! <span class="emphasize2">${req_user}</span> has requested a forced status checks unlock!
    </h3>
    ...
    <table>
        ...
        <tr>
            <td class="label">Status Checks Context(s):</td>
            <td class="value"><span>${st_contexts}</span></td>
        </tr>
        <tr>
