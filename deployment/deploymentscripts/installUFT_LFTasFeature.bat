...
REM net use %STORAGE_WIN_SERVER%\IPC$ %4 /USER:%3
...
set LeanFTConfiguration=LeanFT,LeanFT_Engine,LeanFT_Client,Vs2015Addin,IntelliJAddin,EclipseAddin ECLIPSE_INSTALLDIR="C:\DevTools\eclipse"
